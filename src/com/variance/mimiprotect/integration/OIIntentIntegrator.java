package com.variance.mimiprotect.integration;
...
public class OIIntentIntegrator {

	public static final int REQUEST_CODE = 0x0000c0de; // Only use bottom 16
														// bits
	private static final String TAG = IntentIntegrator.class.getSimpleName();

	public static final String DEFAULT_TITLE = "Install OI FILE MANAGER?";
	public static final String DEFAULT_MESSAGE = "This application requires OI File Manager. Would you like to install it?";
	public static final String DEFAULT_YES = "Yes";
	public static final String DEFAULT_NO = "No";

	private static final String BS_PACKAGE = "org.openintents.filemanager";

	// private static final String PICK_FILE_INTENT =
	...
	public OIIntentIntegrator(Activity activity) {
	 ...
	 */
	/*
	 * public AlertDialog initiateScan() { return initiateScan(ALL_CODE_TYPES);
	 * 
	 * }
	 */
	/**
	...
	public AlertDialog initiateFileSelection(String action, int requestCode,
			Map<String, String> args) {
		Intent intent = new Intent(action);
		intent = attachMoreExtras(intent, args);
	 ...
	 * intent.putExtra("Forg.openintents.extra.TITLE", "Select File");
	 * intent.putExtra("org.openintents.extra.BUTTON_TEXT", "UPLOAD FILE");
	 * 
	 * String targetAppPackage = findTargetAppPackage(intent); if
	 * (targetAppPackage == null) { return showDownloadDialog(); } //
	 * intent.setPackage(targetAppPackage); //
	 * intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); //
	 * intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
	 * 
	 * startActivityForResult(intent, REQUEST_CODE); return null; }
	 */
	/**
				...
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialogInterface, int i) {
						...
						try {
							...
							Log.w(TAG,
									"Android Market is not installed; cannot install OI File Manager");
							// Toast.makeText(null,
							// "Android Market not installed, please install it first",
							// Toast.LENGTH_SHORT);
						}
					}
				});
	...
	private Intent attachMoreExtras(Intent intent, Map<String, String> args) {
